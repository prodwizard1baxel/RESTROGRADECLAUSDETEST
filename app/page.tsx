  ...
  return (
    <main className="min-h-screen bg-white text-slate-800 overflow-hidden">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-500">
            {[
              ...
              <a
                ...
                className="relative hover:text-slate-800 transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-emerald-600 after:transition-all after:duration-300 hover:after:w-full"
              >
                {link.label}
              </a>
            ))}
      ...
      <section className="relative pt-28 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        ...
        <div className="absolute top-20 left-[10%] w-72 h-72 bg-emerald-100/60 rounded-full blur-[100px] animate-float pointer-events-none" />
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="animate-fade-in-up animation-delay-300 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/analyze"
              className="cta-hero group bg-emerald-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-emerald-700 transition-all duration-300 inline-flex items-center justify-center gap-2.5 shadow-2xl shadow-emerald-200 hover:shadow-emerald-300 hover:-translate-y-0.5"
            >
            ...
            <a
              href="/demo"
              className="group border border-slate-300 text-slate-600 px-10 py-4 rounded-xl font-semibold text-lg hover:border-emerald-300 hover:text-emerald-700 hover:bg-emerald-50 transition-all duration-300 inline-flex items-center justify-center gap-2.5"
            >
              <svg className="w-5 h-5 text-emerald-500 transition-transform duration-300 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section id="how-it-works" className="py-20 md:py-32 bg-slate-50 relative">
        <div className="max-w-6xl mx-auto px-6 relative">
          <Reveal className="text-center mb-20">
            <p className="text-sm uppercase tracking-[0.2em] text-emerald-600 font-semibold mb-4">Simple Process</p>
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="bg-white rounded-2xl border border-slate-200 p-8 group relative hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 group-hover:bg-emerald-100 transition-all duration-500 group-hover:scale-110">
                      {item.icon}
                    </div>
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-[0.15em]">Step {item.step}</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-slate-800 group-hover:text-emerald-700 transition-colors duration-300">{item.title}</h3>
          ...
          <Reveal delay={450} className="text-center mt-14">
            <a href="/analyze" className="inline-flex items-center gap-2 text-emerald-600 font-semibold hover:text-emerald-800 transition-colors duration-200 group">
      ...
      <section id="features" className="py-20 md:py-32 bg-white relative">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-emerald-600 font-semibold mb-4">What You Get</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900">
            ...
            {[
              ...
              <Reveal key={i} delay={i * 100}>
                <div className={`bg-white rounded-2xl border border-slate-200 p-7 ${feature.hoverBorder} transition-all duration-500 group hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 h-full`}>
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-slate-800 group-hover:text-emerald-700 transition-colors duration-300">{feature.title}</h3>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-1.5 max-w-4xl mx-auto shadow-xl shadow-slate-200/50">
              <div className="rounded-xl bg-slate-50 p-6 md:p-10 space-y-6">
                <div className="flex items-end justify-between border-b border-slate-200 pb-6">
                  <div>
                    <p className="text-xs text-emerald-600 font-semibold uppercase tracking-[0.15em] mb-1.5">Competitive Intelligence Report</p>
                ...
                <div className="relative pt-4">
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-50 via-slate-50/95 to-transparent z-10 flex items-end justify-center pb-6">
                    <a href="/demo" className="group bg-emerald-600 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-300 text-sm shadow-xl shadow-emerald-200 inline-flex items-center gap-2">
            ...
            {[
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="bg-slate-50 rounded-2xl border border-slate-200 p-8 group hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 h-full flex flex-col transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-emerald-100 border border-emerald-200 flex items-center justify-center text-emerald-600 font-semibold text-sm">{t.name[0]}</div>
                    <div>
      ...
      <section className="py-24 md:py-36 bg-slate-50 relative overflow-hidden">
        ...
        <Reveal className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/analyze" className="cta-hero group bg-emerald-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-emerald-700 transition-all duration-300 shadow-2xl shadow-emerald-200 hover:shadow-emerald-300 hover:-translate-y-0.5 inline-flex items-center justify-center gap-2">
            ...
            <a href="/demo" className="group border border-slate-300 text-slate-600 px-10 py-4 rounded-xl font-semibold text-lg hover:border-emerald-300 hover:text-emerald-700 hover:bg-emerald-50 transition-all duration-300 inline-flex items-center justify-center gap-2">
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                <a href="/analyze" className="text-sm text-slate-400 hover:text-emerald-600 transition-colors">Get Report</a>
                <a href="/demo" className="text-sm text-slate-400 hover:text-emerald-600 transition-colors">Demo</a>
                <a href="#features" className="text-sm text-slate-400 hover:text-emerald-600 transition-colors">Features</a>
              </div>
            </div>
            <div>
