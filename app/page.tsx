  ...
  return (
    <main className="min-h-screen bg-white text-slate-800 overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-indigo-600 flex items-center justify-center font-bold text-white text-sm shadow-lg shadow-indigo-200 group-hover:shadow-indigo-300 transition-shadow duration-300">
              R
            </div>
            <span className="font-semibold text-lg tracking-tight text-slate-800">
              Retro<span className="text-indigo-600">Grade</span>
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-500">
            {[
              ...
              <a
                ...
                className="relative hover:text-slate-800 transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-indigo-600 after:transition-all after:duration-300 hover:after:w-full"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/analyze"
              className="cta-primary bg-indigo-600 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-700 transition-all duration-300 shadow-lg shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-px"
            >
              Get Report
            </a>
      ...
      <section className="relative pt-28 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        ...
        <div className="absolute top-20 left-[10%] w-72 h-72 bg-indigo-100/60 rounded-full blur-[100px] animate-float pointer-events-none" />
        <div className="absolute top-40 right-[5%] w-96 h-96 bg-violet-100/40 rounded-full blur-[120px] animate-float-delayed pointer-events-none" />
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <div className="animate-fade-in-up inline-flex items-center gap-2.5 bg-indigo-50 border border-indigo-200 rounded-full px-5 py-2 mb-8 hover:bg-indigo-100 transition-colors duration-300 cursor-default">
          ...
          <div className="animate-fade-in-up animation-delay-300 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/analyze"
              className="cta-hero group bg-indigo-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-indigo-700 transition-all duration-300 inline-flex items-center justify-center gap-2.5 shadow-2xl shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-0.5"
            >
            ...
            <a
              href="/demo"
              className="group border border-slate-300 text-slate-600 px-10 py-4 rounded-xl font-semibold text-lg hover:border-indigo-300 hover:text-indigo-700 hover:bg-indigo-50 transition-all duration-300 inline-flex items-center justify-center gap-2.5"
            >
              <svg className="w-5 h-5 text-indigo-500 transition-transform duration-300 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-50">
              {["Zomato Partner", "Google Maps", "GPT-4 Powered", "Swiggy Listed", "TripAdvisor"].map((name, i) => (
                <span key={i} className="text-sm md:text-base font-semibold text-slate-500 tracking-wider whitespace-nowrap hover:text-indigo-500 transition-colors duration-500">
                  {name}
                </span>
              ))}
            </div>
      ...
      <section id="how-it-works" className="py-20 md:py-32 bg-slate-50 relative">
        <div className="max-w-6xl mx-auto px-6 relative">
          <Reveal className="text-center mb-20">
            <p className="text-sm uppercase tracking-[0.2em] text-indigo-600 font-semibold mb-4">Simple Process</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-16 left-[20%] right-[20%] h-px bg-gradient-to-r from-transparent via-indigo-200 to-transparent" />
            {[
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="bg-white rounded-2xl border border-slate-200 p-8 group relative hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-100 transition-all duration-500 group-hover:scale-110">
                      {item.icon}
                    </div>
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-[0.15em]">Step {item.step}</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-slate-800 group-hover:text-indigo-700 transition-colors duration-300">{item.title}</h3>
          ...
          <Reveal delay={450} className="text-center mt-14">
            <a href="/analyze" className="inline-flex items-center gap-2 text-indigo-600 font-semibold hover:text-indigo-800 transition-colors duration-200 group">
      ...
      <section id="features" className="py-20 md:py-32 bg-white relative">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-indigo-600 font-semibold mb-4">What You Get</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { title: "Competitor Deep Dive", description: "Strengths, weaknesses, sentiment analysis, and keyword clusters for your top 5 competitors.", color: "text-indigo-600", bgColor: "bg-indigo-50 border-indigo-100", hoverBorder: "hover:border-indigo-300", icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg> },
              ...
              <Reveal key={i} delay={i * 100}>
                <div className={`bg-white rounded-2xl border border-slate-200 p-7 ${feature.hoverBorder} transition-all duration-500 group hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 h-full`}>
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-slate-800 group-hover:text-indigo-700 transition-colors duration-300">{feature.title}</h3>
      ...
      <section id="preview" className="py-20 md:py-32 bg-slate-50 relative">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-indigo-600 font-semibold mb-4">Sample Output</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-1.5 max-w-4xl mx-auto shadow-xl shadow-slate-200/50">
              <div className="rounded-xl bg-slate-50 p-6 md:p-10 space-y-6">
                <div className="flex items-end justify-between border-b border-slate-200 pb-6">
                  <div>
                    <p className="text-xs text-indigo-600 font-semibold uppercase tracking-[0.15em] mb-1.5">Competitive Intelligence Report</p>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl p-4"><p className="text-xs text-slate-400 mb-1">Profile Score</p><p className="text-2xl font-bold text-emerald-600">6/8</p></div>
                </div>
                ...
                <div className="relative pt-4">
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-50 via-slate-50/95 to-transparent z-10 flex items-end justify-center pb-6">
                    <a href="/demo" className="group bg-indigo-600 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-indigo-700 transition-all duration-300 text-sm shadow-xl shadow-indigo-200 inline-flex items-center gap-2">
      ...
      <section id="testimonials" className="py-20 md:py-32 bg-white relative">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-indigo-600 font-semibold mb-4">Trusted by Restaurateurs</p>
            ...
            {[
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="bg-slate-50 rounded-2xl border border-slate-200 p-8 group hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-100 h-full flex flex-col transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-indigo-100 border border-indigo-200 flex items-center justify-center text-indigo-600 font-semibold text-sm">{t.name[0]}</div>
                    <div>
      ...
      <section className="py-24 md:py-36 bg-slate-50 relative overflow-hidden">
        ...
        <Reveal className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/analyze" className="cta-hero group bg-indigo-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-indigo-700 transition-all duration-300 shadow-2xl shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-0.5 inline-flex items-center justify-center gap-2">
            ...
            <a href="/demo" className="group border border-slate-300 text-slate-600 px-10 py-4 rounded-xl font-semibold text-lg hover:border-indigo-300 hover:text-indigo-700 hover:bg-indigo-50 transition-all duration-300 inline-flex items-center justify-center gap-2">
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center font-bold text-white text-sm">R</div>
                <span className="font-semibold text-lg tracking-tight text-slate-800">Retro<span className="text-indigo-600">Grade</span></span>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                <a href="/analyze" className="text-sm text-slate-400 hover:text-indigo-600 transition-colors">Get Report</a>
                <a href="/demo" className="text-sm text-slate-400 hover:text-indigo-600 transition-colors">Demo</a>
                <a href="#features" className="text-sm text-slate-400 hover:text-indigo-600 transition-colors">Features</a>
              </div>
            </div>
            <div>
              <p className="text-sm font-semibold mb-4 text-slate-700">Company</p>
              <div className="flex flex-col gap-2.5">
                <a href="#testimonials" className="text-sm text-slate-400 hover:text-indigo-600 transition-colors">Testimonials</a>
...
function PreviewBars() {
  ...
  const competitors = [
    ...
    { name: "Sequel", score: 58, color: "from-emerald-500 to-emerald-400" },
  ];
